import { $ as resolveConfigPath, D as info, E as danger, I as colorize, L as init_theme, M as setVerbose, O as init_globals, R as isRich, X as init_paths, Y as STATE_DIR, Z as isNixMode, _ as visibleWidth, b as init_restore, bt as normalizeChatChannelId, ft as DEFAULT_CHAT_CHANNEL, g as init_ansi, gt as init_registry, ht as getChatChannelMeta, lt as resolveStateDir, o as init_boolean, rt as resolveGatewayPort, s as parseBooleanValue, st as resolveOAuthDir, v as defaultRuntime, x as restoreTerminalState, y as init_runtime, z as theme } from "./entry.js";
import { C as init_paths$1, F as normalizeProviderId, Ft as init_defaults, M as init_model_selection, Mt as DEFAULT_CONTEXT_TOKENS, Nt as DEFAULT_MODEL, Pt as DEFAULT_PROVIDER, c as resolveApiKeyForProfile, ht as init_model_auth, n as init_auth_profiles, r as resolveAuthProfileOrder, v as upsertAuthProfile, w as resolveAuthStorePath, y as ensureAuthProfileStore, yt as resolveEnvApiKey, z as resolveConfiguredModelRef } from "./auth-profiles-BxOVCPsH.js";
import { n as init_command_format, t as formatCliCommand } from "./command-format-4psjdhj-.js";
import { c as init_session_key, n as DEFAULT_AGENT_ID, t as DEFAULT_ACCOUNT_ID, u as normalizeAgentId } from "./session-key-9TMHrLw0.js";
import { _ as shortenHomePath, c as init_utils, g as shortenHomeInString, h as resolveUserPath, p as resolveHomeDir } from "./utils-C_zAMV2K.js";
import { n as runCommandWithTimeout, t as init_exec } from "./exec-DZOavyKj.js";
import { E as resolveDefaultAgentWorkspaceDir, S as ensureAgentWorkspace, c as resolveAgentWorkspaceDir, g as DEFAULT_IDENTITY_FILENAME, i as resolveAgentDir, l as resolveDefaultAgentId, n as listAgentIds, p as DEFAULT_AGENT_WORKSPACE_DIR, t as init_agent_scope, w as init_workspace } from "./agent-scope-Dw1YEb1p.js";
import { c as writeConfigFile, h as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot, r as createConfigIO } from "./config-DXDJHZxQ.js";
import { n as movePathToTrash } from "./server-context-Drp6DqGU.js";
import { i as randomIdempotencyKey, n as callGateway } from "./call-B7kuA5xc.js";
import { h as GATEWAY_CLIENT_NAMES, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES } from "./message-channel-CAW9X8lp.js";
...
import { Cn as formatTargetDisplay, D as runMemoryStatus, E as registerMemoryCli, Jn as CHANNEL_TARGETS_DESCRIPTION, Tn as CHANNEL_MESSAGE_ACTION_NAMES, Yn as CHANNEL_TARGET_DESCRIPTION, _ as randomToken, a as applyWizardMetadata, c as ensureWorkspaceAndSessions, d as handleReset, dn as resolveCommitHash, f as moveToTrash, fn as lookupContextTokens, hn as runMessageAction, i as DEFAULT_WORKSPACE, l as formatControlUiSshHint, m as openUrl, s as detectBrowserOpenSupport, v as resolveControlUiLinks, x as waitForGatewayReachable } from "./loader-Dn-r2_em.js";
import { n as withProgress } from "./progress-DxhUA14Q.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-C4pp99ls.js";
import { t as WizardCancelledError } from "./prompts-CudpZgTI.js";
import { t as createClackPrompter } from "./clack-prompter-OWgnOHrg.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-Bi7HfKpY.js";
import { n as setupChannels } from "./onboard-channels-CcFw_6Xq.js";
import { a as resolveSessionTranscriptsDirForAgent, i as resolveSessionTranscriptsDir, o as resolveStorePath } from "./paths-DyX06dGK.js";
import { d as loadSessionStore } from "./sandbox-CnyGKEAQ.js";
import { r as runCommandWithRuntime } from "./cli-utils-DzrdzskQ.js";
import { n as ensurePluginRegistryLoaded, t as hasExplicitOptions } from "./command-options-BKpjmU3_.js";
import { l as getVerboseFlag, o as getFlagValue, r as registerSubCliCommands, s as getPositiveIntFlagValue, u as hasFlag } from "./register.subclis-CH_NNOcU.js";
...
import { t as createDefaultDeps } from "./deps-B2a3nbtK.js";
import { a as gatewayInstallErrorHint, h as assertSupportedRuntime, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DOjhJfeq.js";
import { t as resolveGatewayService } from "./service-CKWGsZlB.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-CUEK4tpC.js";
import { t as renderTable } from "./table-DBVF2vnK.js";
import { d as applyAuthChoice, f as applyOpenAIConfig, h as promptAuthChoiceGrouped, m as applyGoogleGeminiModelDefault, p as upsertSharedEnvVar, u as warnIfModelConfigLooksOff } from "./onboard-skills-B3Lb5C3m.js";
import { l as healthCommand } from "./health-format-2c9nuGkw.js";
import { $ as setCloudflareAiGatewayConfig, D as applyMoonshotConfig, Et as validateAnthropicSetupToken, G as applyXiaomiConfig, L as applySyntheticConfig, N as applyQianfanConfig, O as applyMoonshotConfigCn, Q as setAnthropicApiKey, T as applyKimiCodeConfig, Tt as buildTokenProfileId, U as applyXaiConfig, V as applyVercelAiGatewayConfig, at as setMoonshotApiKey, ct as setQianfanApiKey, dt as setVeniceApiKey, f as applyOpencodeZenConfig, ft as setVercelAiGatewayApiKey, g as applyMinimaxConfig, gt as setZaiApiKey, ht as setXiaomiApiKey, it as setMinimaxApiKey, j as applyOpenrouterConfig, m as applyMinimaxApiConfig, mt as setXaiApiKey, nt as setGeminiApiKey, ot as setOpencodeZenApiKey, q as applyZaiConfig, rt as setKimiCodingApiKey, st as setOpenrouterApiKey, ut as setSyntheticApiKey, v as applyAuthProfileConfig, y as applyCloudflareAiGatewayConfig, z as applyVeniceConfig } from "./github-copilot-auth-DSxA9-fA.js";
import { n as logConfigUpdated, t as formatConfigPath } from "./logging-Blyr6p1m.js";
import { a as findAgentEntryIndex, c as pruneAgentConfig, d as parseIdentityMarkdown, f as runOnboardingWizard, i as buildAgentSummaries, l as identityHasValues, o as listAgentEntries, r as applyAgentConfig, s as loadAgentIdentity, t as statusCommand } from "./status-BvPogFJ2.js";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-Cqk4Ghmu.js";
import { t as formatHelpExamples } from "./help-format-iWxCy5-h.js";
import { i as CONFIGURE_WIZARD_SECTIONS, n as configureCommand, r as configureCommandWithSections } from "./configure-CjapAxj-.js";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-CLmCkxbX.js";
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-1hT3dhbh.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-CjapAxj-.js").then((n) => n.t);
