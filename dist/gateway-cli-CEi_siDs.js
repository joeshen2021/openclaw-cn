import { _ as resolveStateDir, a as isNixMode, d as resolveGatewayPort, i as init_paths, r as STATE_DIR, s as resolveConfigPath, t as CONFIG_PATH, u as resolveGatewayLockDir } from "./paths-7Bb9F26w.js";
import { B as normalizeElevatedLevel, H as normalizeThinkLevel, I as formatThinkingLevels, K as supportsXHighThinking, L as formatXHighModelHint, U as normalizeUsageDisplay, V as normalizeReasoningLevel, W as normalizeVerboseLevel } from "./pi-embedded-helpers-tgwYH4iM.js";
import { $ as normalizeOptionalAgentId, $n as isTtsProviderConfigured, $t as registerSkillsChangeListener, An as clearAgentRunContext, Ar as DEFAULT_INPUT_FILE_MIMES, B as isGatewaySigusr1RestartExternallyAllowed, Bn as resolveAgentIdentity, Br as normalizeMimeList, Bt as primeRemoteSkillsCache, C as readSessionPreviewItemsFromTranscript, Cn as dispatchInboundMessage, Cr as parseVerboseOverride, D as ensureOutboundSessionEntry, Dn as stopSubagentsForRequester, Dr as loadModelCatalog, En as isAbortTrigger, Fr as DEFAULT_INPUT_PDF_MAX_PIXELS, Ft as CONTROL_UI_AVATAR_PREFIX, G as formatRestartSentinelMessage, Gn as clearInternalHooks, Gt as approveNodePairing, H as setGatewaySigusr1RestartPolicy, Hn as formatUserTime, Hr as resolveAgentTimeoutMs, Ht as refreshRemoteBinsForConnectedNodes, I as runWithModelFallback, In as normalizePollInput, Ir as DEFAULT_INPUT_PDF_MIN_TEXT_CHARS, It as buildControlUiAvatarUrl, Jn as triggerInternalHook, Jt as renamePairedNode, Kn as createInternalHookEvent, Kt as listNodePairing, Lr as DEFAULT_INPUT_TIMEOUT_MS, Lt as normalizeControlUiBasePath, M as resolveSessionDeliveryTarget, Mn as getAgentRunContext, Mr as DEFAULT_INPUT_IMAGE_MIMES, Nn as onAgentEvent, Nr as DEFAULT_INPUT_MAX_REDIRECTS, O as resolveOutboundSessionRoute, On as initSubagentRegistry, Or as DEFAULT_INPUT_FILE_MAX_BYTES, P as resetDirectoryCache, Pn as registerAgentRunContext, Pr as DEFAULT_INPUT_PDF_MAX_PAGES, Q as inferLegacyName, Qn as isTtsEnabled, Qt as getSkillsSnapshotVersion, R as authorizeGatewaySigusr1Restart, Rr as extractFileContentFromSource, Rt as resolveAssistantAvatarUrl, S as readSessionMessages, Sr as applyVerboseOverride, T as stripEnvelopeFromMessages, Tn as formatZonedTimestamp, Tr as isSystemEventContextChanged, U as consumeRestartSentinel, Un as resolveUserTimeFormat, Ut as refreshRemoteNodeBins, V as scheduleGatewaySigusr1Restart, Vt as recordRemoteNodeInfo, W as formatDoctorNonInteractiveHint, Wn as resolveUserTimezone, Wt as setSkillsRemoteRegistry, X as normalizeCronJobCreate, Xn as OPENAI_TTS_VOICES, Xt as updatePairedNodeMetadata, Y as writeRestartSentinel, Yn as OPENAI_TTS_MODELS, Yt as requestNodePairing, Z as normalizeCronJobPatch, Zn as getTtsProvider, Zt as verifyNodeToken, _ as loadSessionEntry, a as normalizeSendPolicy, ar as setTtsEnabled, b as archiveFileOnDisk, bn as getChannelActivity, c as runEmbeddedPiAgent, cn as normalizeGroupActivation, ct as getPluginToolMeta, dr as startDiagnosticHeartbeat, en as buildSafeExternalPrompt, er as resolveTtsApiKey, et as normalizeOptionalText, f as createOpenClawTools, fn as buildHistoryContextFromEntries, fr as stopDiagnosticHeartbeat, g as loadCombinedSessionStoreForGateway, gn as onHeartbeatEvent, h as listSessionsFromStore, hn as getLastHeartbeatEvent, ht as handleSlackHttpRequest, i as runCliAgent, ir as resolveTtsProviderOrder, j as resolveOutboundTarget, jn as emitAgentEvent, jr as DEFAULT_INPUT_IMAGE_MAX_BYTES, kr as DEFAULT_INPUT_FILE_MAX_CHARS, l as abortEmbeddedPiRun, lr as setCommandLaneConcurrency, lt as loadOpenClawPlugins, m as listAgentsForGateway, mr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, n as getCliSessionId, nn as getHookType, nr as resolveTtsConfig, nt as normalizeRequiredName, o as resolveSendPolicy, or as setTtsProvider, ot as requestHeartbeatNow, p as resolveAnnounceTargetFromKey, pn as resolveHeartbeatVisibility, pr as isDiagnosticsEnabled, q as summarizeRestartSentinel, qn as registerInternalHook, qt as rejectNodePairing, r as setCliSessionId, rn as isExternalHookSession, rr as resolveTtsPrefsPath, rt as migrateLegacyCronPayload, s as clearSessionQueues, sn as createReplyPrefixOptions, sr as textToSpeech, tn as detectSuspiciousPatterns, tr as resolveTtsAutoMode, tt as normalizePayloadToSystemText, u as waitForEmbeddedPiRunEnd, un as registerUnhandledRejectionHandler, ur as CommandLane, ut as loadProviderUsageSummary, v as resolveGatewaySessionStoreTarget, vr as stripHeartbeatToken, w as resolveSessionTranscriptCandidates, wn as createReplyDispatcher, wr as enqueueSystemEvent, wt as handleReset, x as capArrayByJsonBytes, xr as applyModelOverrideToSessionEntry, y as resolveSessionModelRef, yr as lookupContextTokens, z as consumeGatewaySigusr1RestartAuthorization, zr as extractImageContentFromSource, zt as getRemoteSkillEligibility } from "./reply-Cq9qFKEL.js";
import { b as parseAgentSessionKey, c as init_session_key, d as normalizeMainKey, f as resolveAgentIdFromSessionKey, h as toAgentRequestSessionKey, i as buildAgentMainSessionKey, t as DEFAULT_ACCOUNT_ID, u as normalizeAgentId, y as isSubagentSessionKey } from "./session-key-CD-TlcsJ.js";
import { A as getActivePluginRegistry, G as colorize, I as init_globals, J as theme, K as init_theme, T as init_registry, V as setVerbose, X as getLogger, Y as getChildLogger, Z as getResolvedLoggerSettings, a as init_console, d as defaultRuntime, f as init_runtime$1, j as init_runtime, n as init_subsystem, o as setConsoleSubsystemFilter, q as isRich, r as runtimeForLogger, s as setConsoleTimestampPrefix, t as createSubsystemLogger, x as DEFAULT_CHAT_CHANNEL, y as CHANNEL_IDS } from "./subsystem-D_qnfThk.js";
import { S as truncateUtf16Safe, g as resolveUserPath, l as init_utils, s as ensureDir, t as CONFIG_DIR, v as shortenHomePath } from "./utils-D-0UeDZ-.js";
import { c as logDebug, d as logWarn, n as runCommandWithTimeout, r as runExec, s as init_logger, t as init_exec } from "./exec-nNwfnVsi.js";
import { n as resolveOpenClawPackageRoot, t as init_openclaw_root } from "./openclaw-root-CBCdI7WU.js";
import { D as init_workspace_templates, E as resolveDefaultAgentWorkspaceDir, O as resolveWorkspaceTemplateDir, S as ensureAgentWorkspace, _ as DEFAULT_MEMORY_ALT_FILENAME, a as resolveAgentModelFallbacksOverride, b as DEFAULT_TOOLS_FILENAME, c as resolveAgentWorkspaceDir, f as DEFAULT_AGENTS_FILENAME, g as DEFAULT_IDENTITY_FILENAME, h as DEFAULT_HEARTBEAT_FILENAME, i as resolveAgentDir, l as resolveDefaultAgentId, m as DEFAULT_BOOTSTRAP_FILENAME, n as listAgentIds, r as resolveAgentConfig, t as init_agent_scope, u as resolveSessionAgentId, v as DEFAULT_MEMORY_FILENAME, w as init_workspace, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./agent-scope-BKxriAmP.js";
import { Ft as DEFAULT_CONTEXT_TOKENS, It as DEFAULT_MODEL, Lt as DEFAULT_PROVIDER, Rt as init_defaults, a as init_model_selection, f as resolveConfiguredModelRef, g as resolveThinkingDefault, i as getModelRefStatus, m as resolveHooksGmailModel, o as isCliProvider, p as resolveDefaultModelForAgent, u as resolveAllowedModelRef } from "./model-selection-B4yu6Rbo.js";
...
import { n as isTruthyEnvValue, r as logAcceptedEnvOption, t as init_env } from "./env-B64iiAJQ.js";
import { A as resolveSubagentMaxConcurrent, T as applyLegacyMigrations, a as parseConfigJson5, c as writeConfigFile, i as loadConfig, j as VERSION, k as resolveAgentMaxConcurrent, l as validateConfigObjectWithPlugins, n as migrateLegacyConfig, o as readConfigFileSnapshot, r as createConfigIO, s as resolveConfigSnapshotHash, u as OpenClawSchema } from "./config-DBTnQ5MG.js";
import { o as isTestDefaultMemorySlotDisabled } from "./manifest-registry-X2QchV7s.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-C74r-_97.js";
...
import { n as withProgress } from "./progress-CjqhhfuY.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy, t as filterToolsByPolicy } from "./pi-tools.policy-CNqH_lmL.js";
import "./prompt-style-BW5RIhxO.js";
import "./pairing-labels-30hQfc8u.js";
import { i as loadSessionUsageTimeSeries, l as hasNonzeroUsage, n as loadCostUsageSummary, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-CGurmJ4f.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-DLLoysjA.js";
import { c as normalizeExecApprovals, g as saveExecApprovals, l as readExecApprovalsSnapshot, m as resolveExecApprovalsSocketPath, r as ensureExecApprovals } from "./exec-approvals-B50nUIsc.js";
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-Bf1ZadOs.js";
import { t as parseAbsoluteTimeMs } from "./parse-BL4h93pa.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-BnPG73e9.js";
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-KvCywuUp.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-C1IqpDAI.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-DSb_iZul.js";
import "./daemon-runtime-CUpWZP_Z.js";
import { c as loadAgentIdentity, d as loadAgentIdentityFromWorkspace, p as forceFreePortAndWait, r as getStatusSummary, t as runOnboardingWizard } from "./onboarding-BrqGhHNi.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-BImT-wq2.js";
import "./logging-BMKH8Cp-.js";
import "./note-JYpaNLCO.js";
import { t as WizardCancelledError } from "./prompts-Btgcc7vw.js";
import { i as discoverGatewayBeacons, n as installSkill } from "./onboard-skills-CjTE0TnV.js";
import "./github-copilot-auth-E8lYNwd4.js";
import "./onboard-channels-oAasJI9j.js";
import { r as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-BbKE2ufs.js";
import "./archive-CMgCFw4Y.js";
import "./skill-scanner-CXg3PnU6.js";
import "./installs-DjQTqMCh.js";
import { a as resolveControlUiRootOverrideSync, c as getHealthSnapshot, d as runHeartbeatOnce, f as setHeartbeatsEnabled, n as ensureControlUiAssetsBuilt, o as resolveControlUiRootSync, p as startHeartbeatRunner, s as formatHealthChannelLines } from "./health-format-CkXTkFw5.js";
import { S as normalizeUpdateChannel, _ as resolveNpmChannelTag, h as compareSemverStrings, m as checkUpdateStatus, t as runGatewayUpdate, y as DEFAULT_PACKAGE_CHANNEL } from "./update-runner-piSbctln.js";
import { a as resolveGatewayBindHost, n as isLoopbackHost$2, o as resolveGatewayClientIp, r as isTrustedProxyAddress, s as resolveGatewayListenHosts, t as isLoopbackAddress } from "./net-87sp9D09.js";
import { i as resolveGatewayAuth, n as authorizeGatewayConnect, r as isLocalDirectRequest, t as assertGatewayAuthConfigured } from "./auth-UlJs1-OG.js";
import { i as probeGateway } from "./audit-C469Al1u.js";
import "./table-Cl4aryUh.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-pFTOIQ8d.js";
import "./service-BjYI8jh3.js";
import "./systemd-Dzkx9x22.js";
import "./service-audit-CGdHkhGk.js";
import "./node-service-CDh53FB2.js";
import "./channels-status-issues-BwIE4rjn.js";
import "./completion-cli-BtCbQ2J6.js";
import { a as createOutboundSendDeps$1, i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-Ci96z6Ii.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-C1pZ3gGH.js";
import { i as shouldIncludeHook, n as loadWorkspaceHookEntries, r as resolveHookConfig } from "./hooks-status-ZoD8-76F.js";
import "./tui-CEcv1Dk-.js";
import { t as buildChannelAccountSnapshot } from "./status-BF8IVV7c.js";
import "./shared-B3U3XHgp.js";
import { a as runDaemonStop, i as runDaemonStart, n as runDaemonStatus, o as runDaemonUninstall, r as runDaemonRestart, s as runDaemonInstall } from "./daemon-cli-DIBOSSQA.js";
import { a as toOptionString, i as parsePort$1, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-37GZy_R9.js";
import { i as setGatewayWsLogStyle, n as logWs, r as summarizeAgentEventForWsLog, t as formatForLog } from "./ws-log-CHi5yYd1.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-BJr7IDoe.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-ofrm026A.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		const { loadSessionLogs } = await import("./session-cost-usage-CGurmJ4f.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-Bf1ZadOs.js").then((n) => n.t);
