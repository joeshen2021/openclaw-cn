import { H as getResolvedLoggerSettings, X as init_paths, at as resolveLegacyStateDirs, it as resolveIsNixMode, l as init_subsystem, lt as resolveStateDir, n as init_env, ot as resolveNewStateDir, q as CONFIG_PATH, r as isTruthyEnvValue, rt as resolveGatewayPort, st as resolveOAuthDir, v as defaultRuntime, y as init_runtime } from "./entry.js";
import { Ft as init_defaults, Lt as CLAUDE_CLI_PROFILE_ID, M as init_model_selection, Nt as DEFAULT_MODEL, Pt as DEFAULT_PROVIDER, Rt as CODEX_CLI_PROFILE_ID, S as updateAuthProfileStoreWithLock, V as resolveHooksGmailModel, b as init_store, c as resolveApiKeyForProfile, j as getModelRefStatus, m as repairOAuthProfileIdMismatch, n as init_auth_profiles, s as resolveProfileUnusableUntilForDisplay, y as ensureAuthProfileStore, z as resolveConfiguredModelRef } from "./auth-profiles-BxOVCPsH.js";
import { n as init_command_format, t as formatCliCommand } from "./command-format-4psjdhj-.js";
import { c as init_session_key, i as buildAgentMainSessionKey, r as DEFAULT_MAIN_KEY, t as DEFAULT_ACCOUNT_ID, u as normalizeAgentId } from "./session-key-9TMHrLw0.js";
import { _ as shortenHomePath, c as init_utils, p as resolveHomeDir$1, v as sleep } from "./utils-C_zAMV2K.js";
import { n as runCommandWithTimeout, r as runExec, t as init_exec } from "./exec-DZOavyKj.js";
import { n as resolveOpenClawPackageRoot, t as init_openclaw_root } from "./openclaw-root-CD4nFNgv.js";
import { c as resolveAgentWorkspaceDir, f as DEFAULT_AGENTS_FILENAME, l as resolveDefaultAgentId, t as init_agent_scope, w as init_workspace } from "./agent-scope-Dw1YEb1p.js";
import { c as writeConfigFile, n as migrateLegacyConfig, o as readConfigFileSnapshot, u as OpenClawSchema } from "./config-DXDJHZxQ.js";
import { f as inspectPortUsage, m as formatPortDiagnostics } from "./errors-BeT0Sww7.js";
import { a as resolveGatewayBindHost, n as isLoopbackHost } from "./net-DKJPqXuW.js";
import { i as resolveGatewayAuth } from "./auth-Oq-uaP90.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-B7kuA5xc.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-1UOQXTEh.js";
import { n as listChannelPlugins } from "./plugins-DxETvMM5.js";
import { _ as randomToken, a as applyWizardMetadata, h as printWizardHeader, qt as loadModelCatalog, t as loadOpenClawPlugins, u as guardCancel } from "./loader-Dn-r2_em.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-C4pp99ls.js";
import { t as note$1 } from "./note-C5Ox7_1w.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-Bi7HfKpY.js";
import { a as resolveSessionTranscriptsDirForAgent, n as resolveSessionFilePath, o as resolveStorePath } from "./paths-DyX06dGK.js";
import { I as resolveMainSessionKey, N as canonicalizeMainSessionAlias, W as resolveSandboxScope, d as loadSessionStore, et as DEFAULT_SANDBOX_BROWSER_IMAGE, m as saveSessionStore, nt as DEFAULT_SANDBOX_IMAGE, tt as DEFAULT_SANDBOX_COMMON_IMAGE } from "./sandbox-CnyGKEAQ.js";
import { n as isWSLEnv, t as isWSL } from "./wsl-Aj7QICpg.js";
...
import { i as readChannelAllowFromStore } from "./pairing-store-CGTS4GX0.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CnEJ2kZq.js";
import { a as gatewayInstallErrorHint, d as renderSystemNodeWarning, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, p as resolveSystemNodeInfo, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DOjhJfeq.js";
import { a as repairLaunchAgentBootstrap, i as launchAgentPlistExists, n as isLaunchAgentListed, o as resolveGatewayLogPaths, r as isLaunchAgentLoaded, t as resolveGatewayService } from "./service-CKWGsZlB.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-CUEK4tpC.js";
import { n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail } from "./systemd-hints-ChSGKSv-.js";
import { a as renderGatewayServiceCleanupHints, i as findExtraGatewayServices, n as auditGatewayServiceConfig, o as readLastGatewayErrorLine, r as needsNodeRuntimeMigration, t as SERVICE_AUDIT_CODES } from "./service-audit-C06s4xKm.js";
import { i as resolveControlUiDistIndexPathForRoot, l as healthCommand, r as resolveControlUiDistIndexHealth, t as formatHealthCheckFailure } from "./health-format-2c9nuGkw.js";
import { f as doctorShellCompletion, t as runGatewayUpdate } from "./update-runner-Q1DwPgJR.js";
import { n as logConfigUpdated } from "./logging-Blyr6p1m.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-zctNOEqo.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-CwMrIG7N.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CLmCkxbX.js";
