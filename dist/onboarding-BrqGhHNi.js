import { d as resolveGatewayPort, n as DEFAULT_GATEWAY_PORT } from "./paths-7Bb9F26w.js";
import { At as randomToken, Dt as openUrl, Er as peekSystemEvents, Et as normalizeGatewayTokenInput, K as readRestartSentinel, Lt as normalizeControlUiBasePath, Nt as summarizeExistingConfig, Ot as printWizardHeader, Pt as waitForGatewayReachable, St as formatControlUiSshHint, _t as DEFAULT_WORKSPACE, bt as detectBrowserOpenSupport, d as sha256HexPrefix, dt as formatUsageReportLines, jt as resolveControlUiLinks, kt as probeGatewayReachable, m as listAgentsForGateway, q as summarizeRestartSentinel, ut as loadProviderUsageSummary, vt as applyWizardMetadata, wt as handleReset, xt as ensureWorkspaceAndSessions, yr as lookupContextTokens, zn as getMemorySearchManager, zt as getRemoteSkillEligibility } from "./reply-Cq9qFKEL.js";
import { b as parseAgentSessionKey, c as init_session_key, u as normalizeAgentId } from "./session-key-CD-TlcsJ.js";
import { F as info, I as init_globals, J as theme, K as init_theme, d as defaultRuntime, f as init_runtime, m as restoreTerminalState, p as init_restore, q as isRich } from "./subsystem-D_qnfThk.js";
import { g as resolveUserPath, l as init_utils, y as sleep } from "./utils-D-0UeDZ-.js";
import { r as runExec, t as init_exec } from "./exec-nNwfnVsi.js";
import { n as resolveOpenClawPackageRoot, t as init_openclaw_root } from "./openclaw-root-CBCdI7WU.js";
import { c as resolveAgentWorkspaceDir, g as DEFAULT_IDENTITY_FILENAME, i as resolveAgentDir, l as resolveDefaultAgentId, m as DEFAULT_BOOTSTRAP_FILENAME, t as init_agent_scope, w as init_workspace } from "./agent-scope-BKxriAmP.js";
import { Ct as ensureAuthProfileStore, Ft as DEFAULT_CONTEXT_TOKENS, It as DEFAULT_MODEL, Lt as DEFAULT_PROVIDER, Rt as init_defaults, a as init_model_selection, f as resolveConfiguredModelRef, ot as init_auth_profiles } from "./model-selection-B4yu6Rbo.js";
import { a as resolveCliName, n as init_command_format, r as init_cli_name, t as formatCliCommand } from "./command-format-D7BB3K65.js";
import { c as writeConfigFile, i as loadConfig, j as VERSION, o as readConfigFileSnapshot } from "./config-DBTnQ5MG.js";
import { n as listChannelPlugins } from "./plugins-C74r-_97.js";
import { L as resolveMainSessionKey, d as loadSessionStore } from "./sandbox-CV_d6eJA.js";
import { d as inspectPortUsage, f as resolveLsofCommandSync, p as formatPortDiagnostics } from "./chrome-E3qwxmfG.js";
import { o as resolveStorePath } from "./paths-D9O1Itjf.js";
import { t as buildChannelSummary } from "./channel-summary-BMzP579N.js";
...
import { a as findTailscaleBinary, o as getTailnetHostname, s as readTailscaleStatusJson } from "./tailscale-C1IqpDAI.js";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CUpWZP_Z.js";
...
import { c as promptDefaultModel, d as warnIfModelConfigLooksOff, f as applyAuthChoice, g as promptAuthChoiceGrouped, r as promptRemoteGatewayConfig, s as applyPrimaryModel, t as setupSkills, u as resolvePreferredProviderForAuthChoice } from "./onboard-skills-CjTE0TnV.js";
import { n as setupChannels } from "./onboard-channels-oAasJI9j.js";
import { l as healthCommand, n as ensureControlUiAssetsBuilt, s as formatHealthChannelLines, t as formatHealthCheckFailure, u as resolveHeartbeatSummaryForAgent } from "./health-format-CkXTkFw5.js";
import { C as resolveEffectiveUpdateChannel, S as normalizeUpdateChannel, d as formatUpdateOneLiner, f as getUpdateCheckResult, h as compareSemverStrings, l as ensureCompletionCacheExists, m as checkUpdateStatus, p as resolveUpdateAvailability, s as checkShellCompletionStatus, u as formatUpdateAvailableHint, x as formatUpdateChannelLabel } from "./update-runner-piSbctln.js";
import { i as probeGateway, t as runSecurityAudit } from "./audit-C469Al1u.js";
import { t as renderTable } from "./table-Cl4aryUh.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-pFTOIQ8d.js";
import { o as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-BjYI8jh3.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-Dzkx9x22.js";
import { o as readLastGatewayErrorLine } from "./service-audit-CGdHkhGk.js";
import { t as resolveNodeService } from "./node-service-CDh53FB2.js";
...
import { r as installCompletion } from "./completion-cli-BtCbQ2J6.js";
import { t as buildWorkspaceHookStatus } from "./hooks-status-ZoD8-76F.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-CM7xu95j.js").then((n) => n.r);
