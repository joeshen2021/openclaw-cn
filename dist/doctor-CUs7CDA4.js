import { _ as resolveStateDir, d as resolveGatewayPort, f as resolveIsNixMode, h as resolveOAuthDir, i as init_paths, m as resolveNewStateDir, p as resolveLegacyStateDirs, t as CONFIG_PATH } from "./paths-7Bb9F26w.js";
import { At as randomToken, Ct as guardCancel, Dr as loadModelCatalog, Ot as printWizardHeader, lt as loadOpenClawPlugins, vt as applyWizardMetadata } from "./reply-Cq9qFKEL.js";
import { c as init_session_key, i as buildAgentMainSessionKey, r as DEFAULT_MAIN_KEY, t as DEFAULT_ACCOUNT_ID, u as normalizeAgentId } from "./session-key-CD-TlcsJ.js";
import { Z as getResolvedLoggerSettings, d as defaultRuntime, f as init_runtime, n as init_subsystem } from "./subsystem-D_qnfThk.js";
import { l as init_utils, m as resolveHomeDir$1, v as shortenHomePath, y as sleep } from "./utils-D-0UeDZ-.js";
...
import { c as resolveAgentWorkspaceDir, f as DEFAULT_AGENTS_FILENAME, l as resolveDefaultAgentId, t as init_agent_scope, w as init_workspace } from "./agent-scope-BKxriAmP.js";
import { Ct as ensureAuthProfileStore, Et as updateAuthProfileStoreWithLock, It as DEFAULT_MODEL, Lt as DEFAULT_PROVIDER, Nt as CLAUDE_CLI_PROFILE_ID, Pt as CODEX_CLI_PROFILE_ID, Rt as init_defaults, a as init_model_selection, dt as resolveProfileUnusableUntilForDisplay, f as resolveConfiguredModelRef, ft as resolveApiKeyForProfile, i as getModelRefStatus, m as resolveHooksGmailModel, ot as init_auth_profiles, vt as repairOAuthProfileIdMismatch, wt as init_store } from "./model-selection-B4yu6Rbo.js";
...
import { c as writeConfigFile, n as migrateLegacyConfig, o as readConfigFileSnapshot, u as OpenClawSchema } from "./config-DBTnQ5MG.js";
import { n as listChannelPlugins } from "./plugins-C74r-_97.js";
import { L as resolveMainSessionKey, P as canonicalizeMainSessionAlias, Q as resolveSandboxScope, ct as DEFAULT_SANDBOX_BROWSER_IMAGE, d as loadSessionStore, lt as DEFAULT_SANDBOX_COMMON_IMAGE, m as saveSessionStore, ut as DEFAULT_SANDBOX_IMAGE } from "./sandbox-CV_d6eJA.js";
import { d as inspectPortUsage, p as formatPortDiagnostics } from "./chrome-E3qwxmfG.js";
import { a as resolveSessionTranscriptsDirForAgent, n as resolveSessionFilePath, o as resolveStorePath } from "./paths-D9O1Itjf.js";
import { n as isWSL, r as isWSLEnv } from "./dispatcher-Dfaxw239.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-BkifdOGB.js";
import { i as readChannelAllowFromStore } from "./pairing-store-CpvfChZ5.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-BW5RIhxO.js";
import { d as resolveGatewaySystemdServiceName, f as resolveGatewayWindowsTaskName, l as resolveGatewayLaunchAgentLabel, m as resolveNodeLaunchAgentLabel } from "./constants-BwSEqbCV.js";
import { a as gatewayInstallErrorHint, d as renderSystemNodeWarning, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, p as resolveSystemNodeInfo, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CUpWZP_Z.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-BImT-wq2.js";
import { n as logConfigUpdated } from "./logging-BMKH8Cp-.js";
import { t as note$1 } from "./note-JYpaNLCO.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-BbKE2ufs.js";
import { i as resolveControlUiDistIndexPathForRoot, l as healthCommand, r as resolveControlUiDistIndexHealth, t as formatHealthCheckFailure } from "./health-format-CkXTkFw5.js";
import { c as doctorShellCompletion, t as runGatewayUpdate } from "./update-runner-piSbctln.js";
import { a as resolveGatewayBindHost, n as isLoopbackHost } from "./net-87sp9D09.js";
import { i as resolveGatewayAuth } from "./auth-UlJs1-OG.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-pFTOIQ8d.js";
import { a as repairLaunchAgentBootstrap, i as launchAgentPlistExists, n as isLaunchAgentListed, o as resolveGatewayLogPaths, r as isLaunchAgentLoaded, t as resolveGatewayService } from "./service-BjYI8jh3.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-Dzkx9x22.js";
import { a as renderGatewayServiceCleanupHints, i as findExtraGatewayServices, n as auditGatewayServiceConfig, o as readLastGatewayErrorLine, r as needsNodeRuntimeMigration, t as SERVICE_AUDIT_CODES } from "./service-audit-CGdHkhGk.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-BwIE4rjn.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CM7xu95j.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-vt9xJjs_.js";
import { n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail } from "./systemd-hints-D3nn97IV.js";
