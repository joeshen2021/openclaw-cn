import { $ as resolveConfigPath, B as getChildLogger, H as getResolvedLoggerSettings, I as colorize, L as init_theme, M as setVerbose, O as init_globals, R as isRich, St as init_runtime, V as getLogger, X as init_paths, Y as STATE_DIR, Z as isNixMode, c as createSubsystemLogger, f as init_console, ft as DEFAULT_CHAT_CHANNEL, gt as init_registry, i as logAcceptedEnvOption, l as init_subsystem, lt as resolveStateDir, m as setConsoleTimestampPrefix, n as init_env, nt as resolveGatewayLockDir, p as setConsoleSubsystemFilter, q as CONFIG_PATH, r as isTruthyEnvValue, rt as resolveGatewayPort, u as runtimeForLogger, ut as CHANNEL_IDS, v as defaultRuntime, xt as getActivePluginRegistry, y as init_runtime$1, z as theme } from "./entry.js";
import { B as resolveDefaultModelForAgent, Ft as init_defaults, L as resolveAllowedModelRef, M as init_model_selection, Mt as DEFAULT_CONTEXT_TOKENS, N as isCliProvider, Nt as DEFAULT_MODEL, Pt as DEFAULT_PROVIDER, U as resolveThinkingDefault, V as resolveHooksGmailModel, j as getModelRefStatus, z as resolveConfiguredModelRef } from "./auth-profiles-BxOVCPsH.js";
import { n as init_command_format, t as formatCliCommand } from "./command-format-4psjdhj-.js";
import { b as parseAgentSessionKey, c as init_session_key, d as normalizeMainKey, f as resolveAgentIdFromSessionKey, h as toAgentRequestSessionKey, i as buildAgentMainSessionKey, t as DEFAULT_ACCOUNT_ID, u as normalizeAgentId, y as isSubagentSessionKey } from "./session-key-9TMHrLw0.js";
import { _ as shortenHomePath, c as init_utils, h as resolveUserPath, o as ensureDir, t as CONFIG_DIR, x as truncateUtf16Safe } from "./utils-C_zAMV2K.js";
import { c as logDebug, d as logWarn, n as runCommandWithTimeout, r as runExec, s as init_logger, t as init_exec } from "./exec-DZOavyKj.js";
import { n as resolveOpenClawPackageRoot, t as init_openclaw_root } from "./openclaw-root-CD4nFNgv.js";
import { D as init_workspace_templates, E as resolveDefaultAgentWorkspaceDir, O as resolveWorkspaceTemplateDir, S as ensureAgentWorkspace, _ as DEFAULT_MEMORY_ALT_FILENAME, a as resolveAgentModelFallbacksOverride, b as DEFAULT_TOOLS_FILENAME, c as resolveAgentWorkspaceDir, f as DEFAULT_AGENTS_FILENAME, g as DEFAULT_IDENTITY_FILENAME, h as DEFAULT_HEARTBEAT_FILENAME, i as resolveAgentDir, l as resolveDefaultAgentId, m as DEFAULT_BOOTSTRAP_FILENAME, n as listAgentIds, r as resolveAgentConfig, t as init_agent_scope, u as resolveSessionAgentId, v as DEFAULT_MEMORY_FILENAME, w as init_workspace, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./agent-scope-Dw1YEb1p.js";
import "./github-copilot-token-v39qt3h4.js";
import "./pi-model-discovery-B4qI4QFM.js";
import { A as resolveSubagentMaxConcurrent, T as applyLegacyMigrations, a as parseConfigJson5, c as writeConfigFile, i as loadConfig, j as VERSION, k as resolveAgentMaxConcurrent, l as validateConfigObjectWithPlugins, n as migrateLegacyConfig, o as readConfigFileSnapshot, r as createConfigIO, s as resolveConfigSnapshotHash, u as OpenClawSchema } from "./config-DXDJHZxQ.js";
import { o as isTestDefaultMemorySlotDisabled } from "./manifest-registry-BBLIW4ej.js";
import "./server-context-Drp6DqGU.js";
import { d as ensurePortAvailable, f as inspectPortUsage, m as formatPortDiagnostics, n as formatErrorMessage } from "./errors-BeT0Sww7.js";
import { t as rawDataToString } from "./ws-3zr8WUwL.js";
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-DZ96IIRX.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-CYu9dMNU.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-DKHfWJtY.js";
...
import { i as resolveGatewayAuth, n as authorizeGatewayConnect, r as isLocalDirectRequest, t as assertGatewayAuthConfigured } from "./auth-Oq-uaP90.js";
import { $ as validatePollParams, A as validateDevicePairListParams, At as deriveDeviceIdFromPublicKey, B as validateLogsTailParams, C as validateCronListParams, Ct as PROTOCOL_VERSION, D as validateCronStatusParams, Dt as parseSessionLabel, E as validateCronRunsParams, F as validateExecApprovalResolveParams, G as validateNodeInvokeResultParams, H as validateNodeDescribeParams, I as validateExecApprovalsGetParams, J as validateNodePairListParams, K as validateNodeListParams, L as validateExecApprovalsNodeGetParams, M as validateDeviceTokenRevokeParams, Mt as normalizeDevicePublicKeyBase64Url, N as validateDeviceTokenRotateParams, Nt as verifyDeviceSignature, O as validateCronUpdateParams, Ot as buildDeviceAuthPayload, P as validateExecApprovalRequestParams, Q as validateNodeRenameParams, R as validateExecApprovalsNodeSetParams, S as validateCronAddParams, St as validateWizardStatusParams, T as validateCronRunParams, Tt as errorShape, U as validateNodeEventParams, V as validateModelsListParams, W as validateNodeInvokeParams, X as validateNodePairRequestParams, Y as validateNodePairRejectParams, Z as validateNodePairVerifyParams, _ as validateConfigGetParams, _t as validateWebLoginStartParams, a as validateAgentWaitParams, at as validateSessionsPatchParams, b as validateConfigSetParams, bt as validateWizardNextParams, c as validateAgentsFilesSetParams, ct as validateSessionsResolveParams, d as validateChannelsStatusParams, dt as validateSkillsInstallParams, et as validateRequestFrame, f as validateChatAbortParams, ft as validateSkillsStatusParams, g as validateConfigApplyParams, gt as validateWakeParams, h as validateChatSendParams, ht as validateUpdateRunParams, i as validateAgentParams, it as validateSessionsListParams, j as validateDevicePairRejectParams, k as validateDevicePairApproveParams, l as validateAgentsListParams, lt as validateSessionsUsageParams, m as validateChatInjectParams, mt as validateTalkModeParams, n as formatValidationErrors, nt as validateSessionsCompactParams, o as validateAgentsFilesGetParams, ot as validateSessionsPreviewParams, p as validateChatHistoryParams, pt as validateSkillsUpdateParams, q as validateNodePairApproveParams, r as validateAgentIdentityParams, rt as validateSessionsDeleteParams, s as validateAgentsFilesListParams, st as validateSessionsResetParams, tt as validateSendParams, u as validateChannelsLogoutParams, ut as validateSkillsBinsParams, v as validateConfigPatchParams, vt as validateWebLoginWaitParams, w as validateCronRemoveParams, wt as ErrorCodes, x as validateConnectParams, xt as validateWizardStartParams, y as validateConfigSchemaParams, yt as validateWizardCancelParams, z as validateExecApprovalsSetParams } from "./client-D33tCigp.js";
import { n as callGateway, o as loadGatewayTlsRuntime$1 } from "./call-B7kuA5xc.js";
import { f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-CAW9X8lp.js";
import { t as formatDocsLink } from "./links-C6m8ybqL.js";
import { r as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-1UOQXTEh.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-DxETvMM5.js";
import "./logging-B7nsQIlp.js";
import "./accounts-Rby9lX9C.js";
import { $ as approveNodePairing, $n as requestHeartbeatNow, $t as listAgentsForGateway, A as resolveHeartbeatVisibility, An as isGatewaySigusr1RestartExternallyAllowed, Ar as resolveUserTimezone, B as createReplyDispatcher, Bn as normalizeCronJobCreate, Bt as clearAgentRunContext, C as buildControlUiAvatarUrl, Ct as normalizeMimeList, Dr as normalizePollInput, Dt as runEmbeddedPiAgent, En as runWithModelFallback, Et as stopSubagentsForRequester, Fn as formatRestartSentinelMessage, Ft as detectSuspiciousPatterns, G as normalizeSendPolicy, Gn as normalizePayloadToSystemText, Gt as resolveAnnounceTargetFromKey, H as getCliSessionId, Hn as inferLegacyName, Ht as getAgentRunContext, Ir as clearInternalHooks, It as getHookType, J as primeRemoteSkillsCache, Jt as applyModelOverrideToSessionEntry, K as resolveSendPolicy, Kn as normalizeRequiredName, L as getChannelActivity, Ln as summarizeRestartSentinel, Lr as createInternalHookEvent, Lt as isExternalHookSession, M as getLastHeartbeatEvent, Mn as setGatewaySigusr1RestartPolicy, Mt as registerUnhandledRejectionHandler, N as onHeartbeatEvent, Nn as consumeRestartSentinel, Nt as createOpenClawTools, O as createReplyPrefixOptions, On as authorizeGatewaySigusr1Restart, Or as formatUserTime, Ot as abortEmbeddedPiRun, Pn as formatDoctorNonInteractiveHint, Pr as resolveAgentIdentity, Pt as buildSafeExternalPrompt, Q as setSkillsRemoteRegistry, Rr as registerInternalHook, Rt as initSubagentRegistry, S as CONTROL_UI_AVATAR_PREFIX, Sn as resolveSessionDeliveryTarget, St as extractImageContentFromSource, T as resolveAssistantAvatarUrl, Tr as stripHeartbeatToken, Tt as isAbortTrigger, U as setCliSessionId, Un as normalizeOptionalAgentId, Ut as onAgentEvent, Vn as normalizeCronJobPatch, Vt as emitAgentEvent, W as runCliAgent, Wn as normalizeOptionalText, Wt as registerAgentRunContext, X as refreshRemoteBinsForConnectedNodes, Xn as enqueueSystemEvent, Y as recordRemoteNodeInfo, Yt as loadProviderUsageSummary, Z as refreshRemoteNodeBins, Zn as isSystemEventContextChanged, _n as resolveOutboundSessionRoute, _r as CommandLane, _t as DEFAULT_INPUT_PDF_MAX_PAGES, an as archiveFileOnDisk, ar as isTtsEnabled, at as verifyNodeToken, br as isDiagnosticsEnabled, bt as DEFAULT_INPUT_TIMEOUT_MS, cn as readSessionPreviewItemsFromTranscript, cr as resolveTtsAutoMode, d as handleReset, dr as resolveTtsProviderOrder, dt as DEFAULT_INPUT_FILE_MAX_BYTES, en as listSessionsFromStore, et as listNodePairing, fn as lookupContextTokens, fr as setTtsEnabled, ft as DEFAULT_INPUT_FILE_MAX_CHARS, gn as ensureOutboundSessionEntry, gr as setCommandLaneConcurrency, gt as DEFAULT_INPUT_MAX_REDIRECTS, ht as DEFAULT_INPUT_IMAGE_MIMES, in as resolveSessionModelRef, ir as getTtsProvider, it as updatePairedNodeMetadata, jn as scheduleGatewaySigusr1Restart, k as buildHistoryContextFromEntries, kn as consumeGatewaySigusr1RestartAuthorization, kr as resolveUserTimeFormat, kt as waitForEmbeddedPiRunEnd, ln as resolveSessionTranscriptCandidates, lr as resolveTtsConfig, lt as applyVerboseOverride, mn as normalizeGroupActivation, mr as textToSpeech, mt as DEFAULT_INPUT_IMAGE_MAX_BYTES, n as handleSlackHttpRequest, nn as loadSessionEntry, nr as OPENAI_TTS_MODELS, nt as renamePairedNode, on as capArrayByJsonBytes, or as isTtsProviderConfigured, ot as getSkillsSnapshotVersion, pn as clearSessionQueues, pr as setTtsProvider, pt as DEFAULT_INPUT_FILE_MIMES, q as getRemoteSkillEligibility, qn as migrateLegacyCronPayload, qt as loadModelCatalog, rn as resolveGatewaySessionStoreTarget, rr as OPENAI_TTS_VOICES, rt as requestNodePairing, sn as readSessionMessages, sr as resolveTtsApiKey, st as registerSkillsChangeListener, t as loadOpenClawPlugins, tn as loadCombinedSessionStoreForGateway, tr as getPluginToolMeta, tt as rejectNodePairing, un as stripEnvelopeFromMessages, ur as resolveTtsPrefsPath, ut as parseVerboseOverride, vr as startDiagnosticHeartbeat, vt as DEFAULT_INPUT_PDF_MAX_PIXELS, w as normalizeControlUiBasePath, wn as resetDirectoryCache, wt as formatZonedTimestamp, xn as resolveOutboundTarget, xr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, xt as extractFileContentFromSource, yr as stopDiagnosticHeartbeat, yt as DEFAULT_INPUT_PDF_MIN_TEXT_CHARS, z as dispatchInboundMessage, zn as writeRestartSentinel, zr as triggerInternalHook, zt as resolveAgentTimeoutMs } from "./loader-Dn-r2_em.js";
import { n as withProgress } from "./progress-DxhUA14Q.js";
import "./prompt-style-C4pp99ls.js";
import "./note-C5Ox7_1w.js";
import { t as WizardCancelledError } from "./prompts-CudpZgTI.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-Bi7HfKpY.js";
...
import { n as resolveSessionFilePath, o as resolveStorePath, r as resolveSessionTranscriptPath } from "./paths-DyX06dGK.js";
import "./sqlite-BjhYBODp.js";
import { m as detectMime, r as saveMediaBuffer } from "./routes-2X3D2ER0.js";
import { B as normalizeThinkLevel, F as formatXHighModelHint, H as normalizeVerboseLevel, P as formatThinkingLevels, R as normalizeElevatedLevel, V as normalizeUsageDisplay, W as supportsXHighThinking, z as normalizeReasoningLevel } from "./pi-embedded-helpers-BDIYe7XP.js";
import { o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-D5hbzrgM.js";
import { $ as stripPluginOnlyAllowlist, F as resolveExplicitAgentSessionKey, I as resolveMainSessionKey, J as collectExplicitAllowlist, L as resolveMainSessionKeyFromConfig, P as resolveAgentMainSessionKey, Q as resolveToolProfilePolicy, S as mergeDeliveryContext, Y as expandPolicyWithPluginGroups, Z as normalizeToolName, b as deliveryContextFromSession, d as loadSessionStore, g as updateSessionStore, q as buildPluginToolGroups, w as normalizeSessionDeliveryFields, z as snapshotSessionOrigin } from "./sandbox-CnyGKEAQ.js";
import "./channel-summary-BiWNQbGo.js";
import { i as getMachineDisplayName, r as createBrowserRouteDispatcher } from "./wsl-Aj7QICpg.js";
import { d as hasBinary, i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-Cc75jauN.js";
import "./image-CSTr1wLk.js";
import { c as normalizeExecApprovals, g as saveExecApprovals, l as readExecApprovalsSnapshot, m as resolveExecApprovalsSocketPath, r as ensureExecApprovals } from "./exec-approvals-34OpFbkX.js";
import "./redact-Bt-krp_b.js";
import "./tool-display-Ci-Sn6i8.js";
import { t as parseAbsoluteTimeMs } from "./parse-DqAvJRIf.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-Cj6vpZiw.js";
import { i as loadSessionUsageTimeSeries, l as hasNonzeroUsage, n as loadCostUsageSummary, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-yAKMCXiG.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-BcU1flOY.js";
import { c as resolveSubagentToolPolicy, i as filterToolsByPolicy, o as resolveEffectiveToolPolicy, s as resolveGroupToolPolicy } from "./commands-B2o5NObG.js";
...
import "./register.subclis-CH_NNOcU.js";
import "./completion-cli-D5VUc6R0.js";
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-B2a3nbtK.js";
import "./daemon-runtime-DOjhJfeq.js";
import "./service-CKWGsZlB.js";
import "./systemd-CUEK4tpC.js";
import "./shared-nGmqS_o6.js";
import { a as runDaemonStop, i as runDaemonStart, n as runDaemonStatus, o as runDaemonUninstall, r as runDaemonRestart, s as runDaemonInstall } from "./daemon-cli-DKInC3LX.js";
import "./service-audit-C06s4xKm.js";
import "./table-DBVF2vnK.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-CUcLV9v5.js";
import { a as toOptionString, i as parsePort$1, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-CQjoaa1C.js";
import { i as probeGateway } from "./audit-DMj8IhfD.js";
import { g as discoverGatewayBeacons, n as installSkill } from "./onboard-skills-B3Lb5C3m.js";
import { a as resolveControlUiRootOverrideSync, c as getHealthSnapshot, d as runHeartbeatOnce, f as setHeartbeatsEnabled, n as ensureControlUiAssetsBuilt, o as resolveControlUiRootSync, p as startHeartbeatRunner, s as formatHealthChannelLines } from "./health-format-2c9nuGkw.js";
import { S as normalizeUpdateChannel, _ as resolveNpmChannelTag, h as compareSemverStrings, m as checkUpdateStatus, t as runGatewayUpdate, y as DEFAULT_PACKAGE_CHANNEL } from "./update-runner-Q1DwPgJR.js";
import "./github-copilot-auth-DSxA9-fA.js";
import "./logging-Blyr6p1m.js";
import { i as shouldIncludeHook, n as loadWorkspaceHookEntries, r as resolveHookConfig } from "./hooks-status-BBTZZH_j.js";
import { f as runOnboardingWizard, n as getStatusSummary, s as loadAgentIdentity, u as loadAgentIdentityFromWorkspace } from "./status-BvPogFJ2.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-zctNOEqo.js";
import "./tui-CbwFIR1o.js";
import { i as setGatewayWsLogStyle, n as logWs, r as summarizeAgentEventForWsLog, t as formatForLog } from "./ws-log-CpedJDJY.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-P_eaC9N5.js";
import { a as createOutboundSendDeps$1, i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-Cqk4Ghmu.js";
import "./node-service-BPWauxH4.js";
import { n as forceFreePortAndWait } from "./ports-D_bZt1jj.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BVxBrkbj.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		const { loadSessionLogs } = await import("./session-cost-usage-yAKMCXiG.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-DZ96IIRX.js").then((n) => n.t);
