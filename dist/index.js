#!/usr/bin/env node
import { _ as resolveStateDir, a as isNixMode, d as resolveGatewayPort, h as resolveOAuthDir, i as init_paths, r as STATE_DIR, s as resolveConfigPath } from "./paths-7Bb9F26w.js";
import "./pi-embedded-helpers-tgwYH4iM.js";
import { At as randomToken, Dt as openUrl, E as runMessageAction, F as CHANNEL_MESSAGE_ACTION_NAMES, N as formatTargetDisplay, Pt as waitForGatewayReachable, St as formatControlUiSshHint, Tt as moveToTrash, Vr as applyTemplate, _t as DEFAULT_WORKSPACE, an as runMemoryStatus, at as CHANNEL_TARGET_DESCRIPTION, bt as detectBrowserOpenSupport, dn as waitForever, in as registerMemoryCli, it as CHANNEL_TARGETS_DESCRIPTION, jt as resolveControlUiLinks, ln as installUnhandledRejectionHandler, mt as resolveCommitHash, on as monitorWebChannel, t as getReplyFromConfig, vt as applyWizardMetadata, wt as handleReset, xt as ensureWorkspaceAndSessions, yr as lookupContextTokens } from "./reply-Cq9qFKEL.js";
import { c as init_session_key, n as DEFAULT_AGENT_ID, t as DEFAULT_ACCOUNT_ID, u as normalizeAgentId } from "./session-key-CD-TlcsJ.js";
import { F as info, G as colorize, I as init_globals, J as theme, K as init_theme, P as danger, T as init_registry, V as setVerbose, d as defaultRuntime, f as init_runtime, i as enableConsoleCapture, k as normalizeChatChannelId, l as init_ansi, m as restoreTerminalState, p as init_restore, q as isRich, u as visibleWidth, w as getChatChannelMeta, x as DEFAULT_CHAT_CHANNEL } from "./subsystem-D_qnfThk.js";
import { _ as shortenHomeInString, f as normalizeE164, g as resolveUserPath, l as init_utils, m as resolveHomeDir, n as assertWebChannel, p as resolveConfigDir, v as shortenHomePath, x as toWhatsappJid } from "./utils-D-0UeDZ-.js";
import { n as runCommandWithTimeout, r as runExec, t as init_exec } from "./exec-nNwfnVsi.js";
import { E as resolveDefaultAgentWorkspaceDir, S as ensureAgentWorkspace, c as resolveAgentWorkspaceDir, g as DEFAULT_IDENTITY_FILENAME, i as resolveAgentDir, l as resolveDefaultAgentId, n as listAgentIds, p as DEFAULT_AGENT_WORKSPACE_DIR, t as init_agent_scope, w as init_workspace } from "./agent-scope-BKxriAmP.js";
import { Ct as ensureAuthProfileStore, Dt as init_paths$1, Ft as DEFAULT_CONTEXT_TOKENS, H as init_model_auth, It as DEFAULT_MODEL, K as resolveEnvApiKey, Lt as DEFAULT_PROVIDER, Ot as resolveAuthStorePath, Rt as init_defaults, St as upsertAuthProfile, a as init_model_selection, c as normalizeProviderId, f as resolveConfiguredModelRef, ft as resolveApiKeyForProfile, ot as init_auth_profiles, st as resolveAuthProfileOrder } from "./model-selection-B4yu6Rbo.js";
import "./github-copilot-token-DeDg-5yZ.js";
import { a as resolveCliName, i as replaceCliName, n as init_command_format, r as init_cli_name, t as formatCliCommand } from "./command-format-D7BB3K65.js";
import { n as parseBooleanValue, t as init_boolean } from "./boolean-D_9LBJdH.js";
import { i as normalizeEnv, n as isTruthyEnvValue, t as init_env } from "./env-B64iiAJQ.js";
import { c as writeConfigFile, h as parseDurationMs, i as loadConfig, j as VERSION, o as readConfigFileSnapshot, r as createConfigIO } from "./config-DBTnQ5MG.js";
...
import { D as resolveSessionKey, E as deriveSessionKey, d as loadSessionStore, m as saveSessionStore } from "./sandbox-CV_d6eJA.js";
import "./image-C0Sy06WY.js";
import "./pi-model-discovery-ClApXX3l.js";
import { E as formatUncaughtError, c as describePortOwner, l as ensurePortAvailable, s as PortInUseError, u as handlePortError } from "./chrome-E3qwxmfG.js";
import "./skills-Vf9A_Paw.js";
import "./routes-BqNBJKoQ.js";
import { n as movePathToTrash } from "./server-context-BQR6C91y.js";
import { h as GATEWAY_CLIENT_NAMES, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES } from "./message-channel-DFfG8nsN.js";
import "./logging-BZQUHB1O.js";
import "./accounts-C4t_aibg.js";
import { a as resolveSessionTranscriptsDirForAgent, i as resolveSessionTranscriptsDir, o as resolveStorePath } from "./paths-D9O1Itjf.js";
...
import { i as randomIdempotencyKey, n as callGateway } from "./call-BkifdOGB.js";
...
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-BW5RIhxO.js";
...
import { t as createDefaultDeps } from "./deps-KvCywuUp.js";
import { l as ensureBinary, u as promptYesNo } from "./tailscale-C1IqpDAI.js";
import { t as isMainModule } from "./is-main-C6GpLnfL.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-DSb_iZul.js";
import { a as gatewayInstallErrorHint, g as assertSupportedRuntime, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CUpWZP_Z.js";
import { a as buildAgentSummaries, c as loadAgentIdentity, f as parseIdentityMarkdown, i as applyAgentConfig, l as pruneAgentConfig, n as statusCommand, o as findAgentEntryIndex, s as listAgentEntries, t as runOnboardingWizard, u as identityHasValues } from "./onboarding-BrqGhHNi.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-BImT-wq2.js";
import { n as logConfigUpdated, t as formatConfigPath } from "./logging-BMKH8Cp-.js";
import "./note-JYpaNLCO.js";
import { t as WizardCancelledError } from "./prompts-Btgcc7vw.js";
import { t as createClackPrompter } from "./clack-prompter-CrV9bZ_x.js";
import { d as warnIfModelConfigLooksOff, f as applyAuthChoice, g as promptAuthChoiceGrouped, h as applyGoogleGeminiModelDefault, m as upsertSharedEnvVar, p as applyOpenAIConfig } from "./onboard-skills-CjTE0TnV.js";
import { $ as setCloudflareAiGatewayConfig, D as applyMoonshotConfig, Et as validateAnthropicSetupToken, G as applyXiaomiConfig, L as applySyntheticConfig, N as applyQianfanConfig, O as applyMoonshotConfigCn, Q as setAnthropicApiKey, T as applyKimiCodeConfig, Tt as buildTokenProfileId, U as applyXaiConfig, V as applyVercelAiGatewayConfig, at as setMoonshotApiKey, ct as setQianfanApiKey, dt as setVeniceApiKey, f as applyOpencodeZenConfig, ft as setVercelAiGatewayApiKey, g as applyMinimaxConfig, gt as setZaiApiKey, ht as setXiaomiApiKey, it as setMinimaxApiKey, j as applyOpenrouterConfig, m as applyMinimaxApiConfig, mt as setXaiApiKey, nt as setGeminiApiKey, ot as setOpencodeZenApiKey, q as applyZaiConfig, rt as setKimiCodingApiKey, st as setOpenrouterApiKey, ut as setSyntheticApiKey, v as applyAuthProfileConfig, y as applyCloudflareAiGatewayConfig, z as applyVeniceConfig } from "./github-copilot-auth-E8lYNwd4.js";
import { n as setupChannels } from "./onboard-channels-oAasJI9j.js";
import "./plugin-auto-enable-BbKE2ufs.js";
import "./archive-CMgCFw4Y.js";
import "./skill-scanner-CXg3PnU6.js";
import "./installs-DjQTqMCh.js";
import { l as healthCommand } from "./health-format-CkXTkFw5.js";
import "./update-runner-piSbctln.js";
import "./auth-UlJs1-OG.js";
import "./audit-C469Al1u.js";
import { t as renderTable } from "./table-Cl4aryUh.js";
import "./skills-status-pFTOIQ8d.js";
import { t as resolveGatewayService } from "./service-BjYI8jh3.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-Dzkx9x22.js";
import "./service-audit-CGdHkhGk.js";
import "./node-service-CDh53FB2.js";
import "./channels-status-issues-BwIE4rjn.js";
import { c as registerSubCliCommands, d as getPositiveIntFlagValue, f as getVerboseFlag, l as getCommandPath, m as hasHelpOrVersion, p as hasFlag, u as getFlagValue } from "./completion-cli-BtCbQ2J6.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-BSTA42_F.js";
import { t as formatHelpExamples } from "./help-format-DB_U92T8.js";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-Ci96z6Ii.js";
import { i as hasExplicitOptions, n as resolveCliChannelOptions, r as ensurePluginRegistryLoaded } from "./channel-options-BwYjt1Cn.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-BiyEksaK.js";
import { i as CONFIGURE_WIZARD_SECTIONS, n as configureCommand, r as configureCommandWithSections } from "./configure-C6-r1noo.js";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-CM7xu95j.js";
import "./widearea-dns-C1pZ3gGH.js";
import "./auth-health-vt9xJjs_.js";
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-CUs7CDA4.js";
import "./hooks-status-ZoD8-76F.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-C6-r1noo.js").then((n) => n.t);
