...
var PROFILE_NAME_RE;
var init_profile_utils = __esmMin((() => {
	PROFILE_NAME_RE = /^[a-z0-9][a-z0-9_-]{0,63}$/i;
}));
...
var createEmptyRegistry, REGISTRY_STATE, state;
...
var CHAT_CHANNEL_ORDER, CHANNEL_IDS, DEFAULT_CHAT_CHANNEL, CHAT_CHANNEL_META, CHAT_CHANNEL_ALIASES, normalizeChannelKey;
...
var DEFAULT_LOG_DIR, DEFAULT_LOG_FILE, LOG_PREFIX, LOG_SUFFIX, MAX_LOG_AGE_MS, requireConfig$1, externalTransports;
var init_logger = __esmMin((() => {
	...
	requireConfig$1 = createRequire(import.meta.url);
...
var requireConfig, SUPPRESSED_CONSOLE_PREFIXES;
var init_console = __esmMin((() => {
	...
	init_logger();
	init_state();
	requireConfig = createRequire(import.meta.url);
...
var init_subsystem = __esmMin((() => {
	...
	CHANNEL_SUBSYSTEM_PREFIXES = new Set(CHAT_CHANNEL_ORDER);
}));
...
if (!ensureExperimentalWarningSuppressed()) {
	...
	import("./run-main-0rJ52Htc.js").then(({ runCli }) => runCli(process$1.argv)).catch((error) => {
...
//#endregion
export { resolveConfigPath as $, logVerbose as A, getChildLogger as B, init_progress_line as C, requireActivePluginRegistry as Ct, info as D, __esmMin as Dt, danger as E, normalizeProfileName as Et, warn as F, init_levels as G, getResolvedLoggerSettings as H, colorize as I, DEFAULT_GATEWAY_PORT as J, normalizeLogLevel as K, init_theme as L, setVerbose as M, shouldLogVerbose as N, init_globals as O, __exportAll as Ot, success as P, resolveCanonicalConfigPath as Q, isRich as R, clearActiveProgressLine as S, init_runtime$1 as St, unregisterActiveProgressLine as T, init_profile_utils as Tt, init_logger as U, getLogger as V, toPinoLikeLogger as W, init_paths as X, STATE_DIR as Y, isNixMode as Z, visibleWidth as _, listChatChannels as _t, normalizeEnv as a, resolveLegacyStateDirs as at, init_restore as b, normalizeChatChannelId as bt, createSubsystemLogger as c, resolveOAuthPath as ct, enableConsoleCapture as d, CHAT_CHANNEL_ORDER as dt, resolveConfigPathCandidate as et, init_console as f, DEFAULT_CHAT_CHANNEL as ft, init_ansi as g, init_registry as gt, shouldLogSubsystemToConsole as h, getChatChannelMeta as ht, logAcceptedEnvOption as i, resolveIsNixMode as it, logVerboseConsole as j, isVerbose as k, __toCommonJS as kt, init_subsystem as l, resolveStateDir as lt, setConsoleTimestampPrefix as m, formatChannelSelectionLine as mt, init_env as n, resolveGatewayLockDir as nt, init_boolean as o, resolveNewStateDir as ot, setConsoleSubsystemFilter as p, formatChannelPrimerLine as pt, CONFIG_PATH as q, isTruthyEnvValue as r, resolveGatewayPort as rt, parseBooleanValue as s, resolveOAuthDir as st, installProcessWarningFilter as t, resolveDefaultConfigCandidates as tt, runtimeForLogger as u, CHANNEL_IDS as ut, defaultRuntime as v, normalizeAnyChannelId as vt, registerActiveProgressLine as w, setActivePluginRegistry as wt, restoreTerminalState as x, getActivePluginRegistry as xt, init_runtime as y, normalizeChannelId as yt, theme as z };