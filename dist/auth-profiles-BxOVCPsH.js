import { Dt as __esmMin, Ot as __exportAll, X as init_paths$1, c as createSubsystemLogger, ct as resolveOAuthPath, l as init_subsystem, lt as resolveStateDir, n as init_env, r as isTruthyEnvValue } from "./entry.js";
import { n as init_command_format, t as formatCliCommand } from "./command-format-4psjdhj-.js";
import { c as init_session_key, n as DEFAULT_AGENT_ID } from "./session-key-9TMHrLw0.js";
import { c as init_utils, h as resolveUserPath } from "./utils-C_zAMV2K.js";
import { o as resolveAgentModelPrimary, t as init_agent_scope } from "./agent-scope-Dw1YEb1p.js";
import { a as init_json_file, i as resolveCopilotApiToken, o as loadJsonFile, r as init_github_copilot_token, s as saveJsonFile, t as DEFAULT_COPILOT_API_BASE_URL } from "./github-copilot-token-v39qt3h4.js";
...
//#endregion
export { normalizeProviders as $, buildModelAliasIndex as A, init_cloudflare_ai_gateway as At, resolveDefaultModelForAgent as B, init_paths as C, init_shell_env as Ct, resolveOpenClawAgentDir as D, shouldEnableShellEnvFallback as Dt, init_agent_paths as E, shouldDeferShellEnvFallback as Et, normalizeProviderId as F, init_defaults as Ft, QIANFAN_DEFAULT_MODEL_ID as G, resolveModelRefFromString as H, parseModelRef as I, resolveAuthProfileDisplayLabel as It, XIAOMI_DEFAULT_MODEL_ID as J, VOLCENGINE_API_BASE_URL as K, resolveAllowedModelRef as L, CLAUDE_CLI_PROFILE_ID as Lt, init_model_selection as M, DEFAULT_CONTEXT_TOKENS as Mt, isCliProvider as N, DEFAULT_MODEL as Nt, buildAllowedModelSet as O, CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF as Ot, modelKey as P, DEFAULT_PROVIDER as Pt, normalizeGoogleModelId as Q, resolveAllowlistModelKey as R, CODEX_CLI_PROFILE_ID as Rt, updateAuthProfileStoreWithLock as S, getShellPathFromLoginShell as St, resolveAuthStorePathForDisplay as T, resolveShellEnvFallbackTimeoutMs as Tt, resolveThinkingDefault as U, resolveHooksGmailModel as V, QIANFAN_BASE_URL as W, buildXiaomiProvider as X, buildQianfanProvider as Y, init_models_config_providers as Z, setAuthProfileOrder as _, resolveApiKeyForProvider as _t, markAuthProfileFailure as a, VENICE_MODEL_CATALOG as at, init_store as b, resolveModelAuthMode as bt, resolveApiKeyForProfile as c, SYNTHETIC_BASE_URL as ct, generateChutesPkce as d, buildSyntheticModelDefinition as dt, resolveImplicitBedrockProvider as et, init_chutes_oauth as f, init_synthetic_models as ft, markAuthProfileGood as g, requireApiKey as gt, listProfilesForProvider as h, init_model_auth as ht, isProfileInCooldown as i, VENICE_DEFAULT_MODEL_REF as it, getModelRefStatus as j, resolveCloudflareAiGatewayBaseUrl as jt, buildConfiguredAllowlistKeys as k, buildCloudflareAiGatewayModelDefinition as kt, CHUTES_AUTHORIZE_ENDPOINT as l, SYNTHETIC_DEFAULT_MODEL_REF as lt, repairOAuthProfileIdMismatch as m, getCustomProviderApiKey as mt, init_auth_profiles as n, resolveImplicitProviders as nt, markAuthProfileUsed as o, buildVeniceModelDefinition as ot, parseOAuthCallbackInput as p, getApiKeyForModel as pt, XIAOMI_API_BASE_URL as q, resolveAuthProfileOrder as r, VENICE_BASE_URL as rt, resolveProfileUnusableUntilForDisplay as s, init_venice_models as st, auth_profiles_exports as t, resolveImplicitCopilotProvider as tt, exchangeChutesCodeForTokens as u, SYNTHETIC_MODEL_CATALOG as ut, upsertAuthProfile as v, resolveAwsSdkEnvVarName as vt, resolveAuthStorePath as w, loadShellEnvFallback as wt, loadAuthProfileStore as x, getShellEnvAppliedKeys as xt, ensureAuthProfileStore as y, resolveEnvApiKey as yt, resolveConfiguredModelRef as z };