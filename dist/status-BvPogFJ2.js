import { D as info, J as DEFAULT_GATEWAY_PORT, L as init_theme, O as init_globals, R as isRich, b as init_restore, rt as resolveGatewayPort, v as defaultRuntime, x as restoreTerminalState, y as init_runtime, z as theme } from "./entry.js";
import { Ft as init_defaults, M as init_model_selection, Mt as DEFAULT_CONTEXT_TOKENS, Nt as DEFAULT_MODEL, Pt as DEFAULT_PROVIDER, n as init_auth_profiles, y as ensureAuthProfileStore, z as resolveConfiguredModelRef } from "./auth-profiles-BxOVCPsH.js";
import { a as resolveCliName, n as init_command_format, r as init_cli_name, t as formatCliCommand } from "./command-format-4psjdhj-.js";
import { b as parseAgentSessionKey, c as init_session_key, u as normalizeAgentId } from "./session-key-9TMHrLw0.js";
import { c as init_utils, h as resolveUserPath } from "./utils-C_zAMV2K.js";
import { r as runExec, t as init_exec } from "./exec-DZOavyKj.js";
import { n as resolveOpenClawPackageRoot, t as init_openclaw_root } from "./openclaw-root-CD4nFNgv.js";
import { c as resolveAgentWorkspaceDir, g as DEFAULT_IDENTITY_FILENAME, i as resolveAgentDir, l as resolveDefaultAgentId, m as DEFAULT_BOOTSTRAP_FILENAME, t as init_agent_scope, w as init_workspace } from "./agent-scope-Dw1YEb1p.js";
import { c as writeConfigFile, i as loadConfig, j as VERSION, o as readConfigFileSnapshot } from "./config-DXDJHZxQ.js";
import { f as inspectPortUsage, m as formatPortDiagnostics } from "./errors-BeT0Sww7.js";
import { a as findTailscaleBinary, o as getTailnetHostname, s as readTailscaleStatusJson } from "./tailscale-DKHfWJtY.js";
...
import { $t as listAgentsForGateway, At as sha256HexPrefix, In as readRestartSentinel, Ln as summarizeRestartSentinel, Nr as getMemorySearchManager, Qn as peekSystemEvents, Xt as formatUsageReportLines, Yt as loadProviderUsageSummary, _ as randomToken, a as applyWizardMetadata, b as summarizeExistingConfig, c as ensureWorkspaceAndSessions, d as handleReset, fn as lookupContextTokens, g as probeGatewayReachable, h as printWizardHeader, i as DEFAULT_WORKSPACE, l as formatControlUiSshHint, m as openUrl, p as normalizeGatewayTokenInput, q as getRemoteSkillEligibility, s as detectBrowserOpenSupport, v as resolveControlUiLinks, w as normalizeControlUiBasePath, x as waitForGatewayReachable } from "./loader-Dn-r2_em.js";
...
import { o as resolveStorePath } from "./paths-DyX06dGK.js";
import { I as resolveMainSessionKey, d as loadSessionStore } from "./sandbox-CnyGKEAQ.js";
import { t as buildChannelSummary } from "./channel-summary-BiWNQbGo.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CnEJ2kZq.js";
import { r as installCompletion } from "./completion-cli-D5VUc6R0.js";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DOjhJfeq.js";
import { o as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-CKWGsZlB.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-CUEK4tpC.js";
import { o as readLastGatewayErrorLine } from "./service-audit-C06s4xKm.js";
import { t as renderTable } from "./table-DBVF2vnK.js";
import { i as probeGateway, t as runSecurityAudit } from "./audit-DMj8IhfD.js";
import { d as applyAuthChoice, h as promptAuthChoiceGrouped, l as resolvePreferredProviderForAuthChoice, o as applyPrimaryModel, r as promptRemoteGatewayConfig, s as promptDefaultModel, t as setupSkills, u as warnIfModelConfigLooksOff } from "./onboard-skills-B3Lb5C3m.js";
import { l as healthCommand, n as ensureControlUiAssetsBuilt, s as formatHealthChannelLines, t as formatHealthCheckFailure, u as resolveHeartbeatSummaryForAgent } from "./health-format-2c9nuGkw.js";
import { C as resolveEffectiveUpdateChannel, S as normalizeUpdateChannel, c as formatUpdateOneLiner, d as checkShellCompletionStatus, h as compareSemverStrings, l as getUpdateCheckResult, m as checkUpdateStatus, p as ensureCompletionCacheExists, s as formatUpdateAvailableHint, u as resolveUpdateAvailability, x as formatUpdateChannelLabel } from "./update-runner-Q1DwPgJR.js";
import { n as logConfigUpdated } from "./logging-Blyr6p1m.js";
import { t as buildWorkspaceHookStatus } from "./hooks-status-BBTZZH_j.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-zctNOEqo.js";
import { t as runTui } from "./tui-CbwFIR1o.js";
import { t as resolveNodeService } from "./node-service-BPWauxH4.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-CLmCkxbX.js").then((n) => n.r);
