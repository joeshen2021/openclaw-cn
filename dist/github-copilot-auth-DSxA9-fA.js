import { Dt as __esmMin, Ot as __exportAll, c as createSubsystemLogger, kt as __toCommonJS, l as init_subsystem } from "./entry.js";
import { A as buildModelAliasIndex, At as init_cloudflare_ai_gateway, D as resolveOpenClawAgentDir, E as init_agent_paths, F as normalizeProviderId, Ft as init_defaults, G as QIANFAN_DEFAULT_MODEL_ID, H as resolveModelRefFromString, J as XIAOMI_DEFAULT_MODEL_ID$1, M as init_model_selection, Ot as CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF, Pt as DEFAULT_PROVIDER, W as QIANFAN_BASE_URL, X as buildXiaomiProvider, Y as buildQianfanProvider, Z as init_models_config_providers, at as VENICE_MODEL_CATALOG, ct as SYNTHETIC_BASE_URL, dt as buildSyntheticModelDefinition, ft as init_synthetic_models, it as VENICE_DEFAULT_MODEL_REF, jt as resolveCloudflareAiGatewayBaseUrl, kt as buildCloudflareAiGatewayModelDefinition, lt as SYNTHETIC_DEFAULT_MODEL_REF, n as init_auth_profiles, ot as buildVeniceModelDefinition, rt as VENICE_BASE_URL, st as init_venice_models, ut as SYNTHETIC_MODEL_CATALOG, v as upsertAuthProfile, y as ensureAuthProfileStore } from "./auth-profiles-BxOVCPsH.js";
import { n as init_command_format, t as formatCliCommand } from "./command-format-4psjdhj-.js";
import { c as init_session_key, u as normalizeAgentId } from "./session-key-9TMHrLw0.js";
import { n as listAgentIds, t as init_agent_scope } from "./agent-scope-Dw1YEb1p.js";
import { c as writeConfigFile, o as readConfigFileSnapshot } from "./config-DXDJHZxQ.js";
import { t as loadOpenClawPlugins } from "./loader-Dn-r2_em.js";
import { r as stylePromptTitle } from "./prompt-style-C4pp99ls.js";
import { n as isWSLEnv } from "./wsl-Aj7QICpg.js";
